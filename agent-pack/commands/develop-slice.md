...
5. Hand off to `deck-safety-reviewer` before finalizing any change to risk ceilings, approval-token boundaries, staged-action semantics, or execution permissions.
