...
_EXPORTS = {
    "ActionValidationError": ("deck_assistant_core.actions", "ActionValidationError"),
    "ApprovalRiskMismatch": ("deck_assistant_core.actions", "ApprovalRiskMismatch"),
    "ApprovalRequirement": ("deck_assistant_core.risk", "ApprovalRequirement"),
    "ApprovalTokenMetadata": ("deck_assistant_core.actions", "ApprovalTokenMetadata"),
    "apply_cli_permission_bypass": (
        "deck_assistant_core.cli",
        "apply_cli_permission_bypass",
    ),
    "BackupSpec": ("deck_assistant_core.actions", "BackupSpec"),
    ...
    "CommandSpec": ("deck_assistant_core.actions", "CommandSpec"),
    ...
    "FileEditSpec": ("deck_assistant_core.actions", "FileEditSpec"),
    ...
    "PolicyViolation": ("deck_assistant_core.risk", "PolicyViolation"),
    ...
    "RollbackStep": ("deck_assistant_core.actions", "RollbackStep"),
    ...
    "StagedAction": ("deck_assistant_core.actions", "StagedAction"),
    "StagedActionMetadata": ("deck_assistant_core.actions", "StagedActionMetadata"),
    "StagedActionNotFound": ("deck_assistant_core.actions", "StagedActionNotFound"),
    "StagedActionStore": ("deck_assistant_core.actions", "StagedActionStore"),
    "StagedActionStoreError": ("deck_assistant_core.actions", "StagedActionStoreError"),
